                    ...
                    <div id="cards">
                        {cityData.map((x, index) => (
                            <div key={index} className="card">
                                ...
                                <div id="pri">
                                    <div id="left">
                                        <h2 id="h1inner">{x.name}</h2> {/* Ensure API has title */}
                                        <p id="h1inner">Duration</p> {/* Ensure API has description */}
                                    </div>
                                    <div id="right">
                                        <p id="h1inner">₹{x.costPerHead}</p>
                                        <p id="h1inner">{x.duration} hours</p>
                                    </div>
                                </div>
